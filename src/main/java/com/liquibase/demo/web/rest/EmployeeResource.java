...
import com.liquibase.demo.domain.Employee;
import com.liquibase.demo.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.liquibase.demo.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
