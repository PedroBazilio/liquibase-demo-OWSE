  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="liquibaseDemoApp.region.home.createOrEditLabel"
          data-cy="RegionCreateUpdateHeading"
          v-text="$t('liquibaseDemoApp.region.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('liquibaseDemoApp.region.regionName')" for="region-regionName">Region Name</label>
            <input
              type="text"
              class="form-control"
              name="regionName"
