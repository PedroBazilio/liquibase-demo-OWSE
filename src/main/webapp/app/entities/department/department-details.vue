    ...
    <div class="col-8">
      <div v-if="department">
        <h2 class="jh-entity-heading" data-cy="departmentDetailsHeading">
          <span v-text="$t('liquibaseDemoApp.department.detail.title')">Department</span> {{ department.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('liquibaseDemoApp.department.departmentName')">Department Name</span>
          </dt>
          <dd>
            <span>{{ department.departmentName }}</span>
          </dd>
          <dt>
            <span v-text="$t('liquibaseDemoApp.department.location')">Location</span>
          </dt>
          <dd>
